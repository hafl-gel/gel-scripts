...
# source("~/repos/3_Scripts/4_MiniDOASAuswertung/RScripts/miniDOAS_functions_filters.R")
# source("~/repos/3_Scripts/4_MiniDOASAuswertung/RScripts/miniDOAS_functions_fitting.R")
# source("~/repos/3_Scripts/4_MiniDOASAuswertung/RScripts/miniDOAS_functions_plotting.R")
# source("~/repos/3_Scripts/4_MiniDOASAuswertung/RScripts/miniDOAS_functions_spectrometer.R")
# source("~/repos/3_Scripts/4_MiniDOASAuswertung/RScripts/miniDOAS_functions_others.R")
# source("~/repos/3_Scripts/4_MiniDOASAuswertung/RScripts/miniDOAS_functions_tools.R")
